        ...
        function t(t, i, a) {
            ...
            (this.target = t),
                ...
                (this.count = function (t) {
                    ...
                    (u.remaining = u.duration - i),
                        u.useEasing
                            ...
                            ? (u.frameVal =
                                  u.startVal -
                                  (u.startVal - u.endVal) * (i / u.duration))
                            : (u.frameVal =
                                  u.startVal +
                                  (u.endVal - u.startVal) * (i / u.duration)),
                        u.countDown
                            ? (u.frameVal =
                            ...
                            : (u.frameVal =
                                  u.frameVal > u.endVal
                                      ...
                                      : u.frameVal),
                        (u.frameVal =
                            Math.round(u.frameVal * u.decimalMult) /
                            u.decimalMult),
                ...
                (this.easeOutExpo = function (t, i, a, s) {
                    return (
                        (a * (1 - Math.pow(2, (-10 * t) / s)) * 1024) / 1023 + i
                    );
                }),
