                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('reset.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg bg-gradient-info w-100 mt-4 mb-0">Send
                                                Reset
                                                Link</button>
                                        </div>
                                    </form>
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-info h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <img class="position-relative" src="{{ asset('img\logos\logo-sai.png') }}"
                                    alt="LOGO PT SAI">
                                <h3 class="text-white font-weight-bolder position-relative">"PT. Surabaya Autocomp
                                    Indonesia"</h3>
                                <h5 class="text-white position-relative">Wiring Harness Manufacture</h5>
                            </div>
                        </div>
                    </div>
                </div>
